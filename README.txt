...
Installation/Deployment
    ...
    * cal "./TestAssignment1.sh media/video media/audio outputFolder" (Linux/MacOSX/cygwin) 
        or "TestAssignment1.bat media\video media\audio outputFolder" (Windows shell) 
        to test your assignment. You can find a log at "AntOutput.txt".  
